...
class CartViewHolder(
    ...
    private fun setCartData(item: CartMenu) {
        with(binding) {
            ...
            tvProductPrice.text = (item.cart.itemQuantity * item.menu.priceOfMenu).toCurrencyFormat()
        }
    }
...
class CartOrderViewHolder(
    ...
    private fun setCartData(item: CartMenu) {
        with(binding) {
            ...
            tvMenuName.text = item.menu.nameOfMenu
            tvMenuPrice.text = (item.cart.itemQuantity * item.menu.priceOfMenu).toCurrencyFormat()
        }
    }
